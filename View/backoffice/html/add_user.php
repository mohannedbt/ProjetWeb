...
button { padding:10px 20px; border-radius:10px; border:none; font-weight:bold; background:linear-gradient(45deg,#00ff00,#7fff00); color:#000; cursor:pointer; transition:0.3s; }
...
<div class="navbar">
    ...
    <div class="nav-logo">Add User</div>
</div>
